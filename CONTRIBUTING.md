...
- **Definition support**: Sends `textDocument/definition` requests to find symbol definitions
...
- **Definition tool**: Exposes `get_definition` to jump to symbol definitions
...
3. Use MCP tools:
   ...
   - `get_definition` (to jump to symbol definitions)
